      ...
      <main className="flex-1 bg-background">
        ...
        {holdQuery.data ? (
          <div className="mx-auto grid max-w-content gap-7 px-5 py-10 sm:px-8 lg:grid-cols-[1fr_22rem]">
            <section>
              <p className="text-sm font-semibold text-brand">Secure checkout</p>
              <h1 className="mt-1 text-3xl font-bold tracking-tight">Complete your booking</h1>
              <div className="mt-5 inline-flex items-center gap-3 rounded-lg bg-brand-soft px-4 py-3 text-brand">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">
                      {holdQuery.data.show?.movie.title ?? 'Movie booking'}
                    </h2>
                    {holdQuery.data.show ? (
                      <>
              ...
              <Card className="mt-6">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted">
                      Secure Stripe-hosted payment. Use a Stripe test card in test mode.
                    </p>
                  </div>
                  <Badge variant="nowShowing">Stripe test mode</Badge>
                </div>
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <Input defaultValue="Ashish" label="Name on ticket" required />
                  <Input defaultValue="Stripe Checkout" disabled label="Payment method" />
                </div>
              </Card>
